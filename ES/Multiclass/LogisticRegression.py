...
#Train:
tweets_df = pd.read_excel('/Users/oscar/Desktop/train_es_sin_hs.xlsx', header=0, encoding='iso8859_15')

#Tweets to predict:
tweets = pd.read_excel('/Users/oscar/Desktop/Test_Es_sin_hs.xlsx', header=0, encoding='iso8859_15')

#Stopwords + spanish "special" punctuation

#Sin editar. 
spa_stop = stopwords.words('spanish')
#Eliminando negaciones.
...
index = random.sample(range(tweet_preds.shape[0]), 50)
