...
#Export pkl
joblib.dump(GridSearch_SVM, "model_User_Tweet_Input_SVM_bi.pkl")
joblib.dump(GridSearch_Log_Reg, "model_User_Tweet_Input_Logistic_Regression_bi.pkl")
joblib.dump(GridSearch_MultinomialNB, "model_User_Tweet_Input_MultinomialNB_bi.pkl")

#import pkl
model_Logistic_Regression = joblib.load("model_User_Tweet_Input_Logistic_Regression_bi.pkl")
model_SVM_best_parameters = joblib.load("model_User_Tweet_Input_SVM_bi.pkl")
model_MultinomialNB = joblib.load("model_User_Tweet_Input_MultinomialNB_bi.pkl")
